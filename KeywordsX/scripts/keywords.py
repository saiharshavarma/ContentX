...
class Keywords:
    ...
    def getKeywords(self, text):
        ...
        cwname = open(
            "KeywordsX/lists/google-10000-english-master/google-10000-english.txt", "r")
        cwlist = []
        ...
        for word in text.split(" "):
            ...
            # print(word)
            # and not (bool(re.match('^[a-zA-Z0-9]*$', word2))):
            if not word2.isnumeric() and word2 not in list(symbols):
        ...
        res = {key: val for key, val in sorted(
            datadict.items(), key=lambda ele: ele[1], reverse=True)}
